app.directive('inviteAction', ['Global', function (Global) {
  return {
    ...
    link: function ($scope, element, attrs) {
      ...
      $(element).find('#actionImgLink').attr('href', '/users/'+$scope.action.object[0].userId.username);
      ...
      $(element).find('#secondActionImgLink').attr('href', '/events/'+$scope.action.subject[0].eventId.id);
    },
  }
}]);